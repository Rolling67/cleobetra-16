...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-bff76fa8');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-bff76fa8');}
...
var brandEl=document.querySelector('.rl-brand-bff76fa8');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
